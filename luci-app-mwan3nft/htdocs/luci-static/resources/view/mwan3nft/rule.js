...
return view.extend({
	...
	render: function() {
		...
		o = s.taboption('general', form.Value, 'proto', _('Protocol'),
			_('Match protocol. E.g., tcp, udp, icmp. Space separated for multiple.'));
		o.placeholder = 'tcp udp';

		o = s.taboption('general', form.Value, 'src_port', _('Source Port'),
			_('Match source port. Space separated for multiple.'));
		...
		o = s.taboption('general', form.Value, 'dest_port', _('Destination Port'),
			_('Match destination port. Space separated for multiple.'));
		o.datatype = 'list(neg(portrange))';
